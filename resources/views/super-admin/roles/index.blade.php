    ...
    <div x-data="roleManager()">
        ...
        <div class="ems-card ems-card--flush" @click="handlePaginationClick($event)">
            ...
            <div class="ems-dt-toolbar">
                ...
                <div class="ems-dt-toolbar__right">
                    <div class="ems-dt-perpage">
                        <label for="role_per_page">Tampilkan</label>
                        <select id="role_per_page" class="ems-dt-perpage__select" x-model="perPage" @change="changePerPage()">
            ...
            <div class="ems-dt-bulk" x-show="selectedCount > 0" x-cloak>
                <span class="ems-dt-bulk__count"><span x-text="selectedCount"></span> role terpilih</span>
                <button type="button" class="ems-dt-bulk__btn ems-dt-bulk__btn--danger" @click="deleteSelected()">
                    Hapus Terpilih
                </button>
            </div>

            <form id="bulk-delete-form" method="POST" action="{{ route('super-admin.roles.bulk-destroy') }}">
                @csrf
                @method('DELETE')
                <template x-for="id in selected" :key="id">
                    <input type="hidden" name="role_ids[]" :value="id">
                </template>
            </form>
