        ...
        <tbody>
            @forelse ($departments as $department)
                <tr>
                    ...
                    <td class="ems-table__muted">{{ $department->departmentManager?->full_name ?? '-' }}</td>
                    <td class="ems-table__muted">{{ $department->departmentHr?->full_name ?? '-' }}</td>
                        ...
                        <div class="ems-dt-actions">
                            <button
                                ...
                                @click="openEdit({
                                    ...
                                    hr_employee_id: {{ $department->hr_employee_id ?? 'null' }},
                                })"
                            >
