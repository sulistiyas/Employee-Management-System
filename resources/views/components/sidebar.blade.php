    ...
    <nav class="ems-sidebar__nav">
        ...
        <div class="ems-sidebar__section">
            ...
            <a href="{{ route('superadmin.dashboard') }}"
               class="ems-sidebar__link {{ request()->routeIs('superadmin.dashboard') ? 'ems-sidebar__link--active' : '' }}">
        ...
        <div class="ems-sidebar__section">
            ...
            <a href="{{ route('superadmin.employees.index') }}"
               class="ems-sidebar__link {{ request()->routeIs('superadmin.employees.*') ? 'ems-sidebar__link--active' : '' }}">
                <span class="ems-sidebar__icon">
            ...
            <a href="{{ route('superadmin.departments.index') }}"
               class="ems-sidebar__link {{ request()->routeIs('superadmin.departments.*') ? 'ems-sidebar__link--active' : '' }}">
                <span class="ems-sidebar__icon">
            ...
            <a href="{{ route('superadmin.positions.index') }}"
               class="ems-sidebar__link {{ request()->routeIs('superadmin.positions.*') ? 'ems-sidebar__link--active' : '' }}">
                <span class="ems-sidebar__icon">
        ...
        <div class="ems-sidebar__section">
            ...
            <a href="{{ route('superadmin.attendances.index') }}"
               class="ems-sidebar__link {{ request()->routeIs('superadmin.attendances.*') ? 'ems-sidebar__link--active' : '' }}">
                <span class="ems-sidebar__icon">
            ...
            <a href="{{ route('superadmin.shifts.index') }}"
               class="ems-sidebar__link {{ request()->routeIs('superadmin.shifts.*') ? 'ems-sidebar__link--active' : '' }}">
                <span class="ems-sidebar__icon">
            ...
            <a href="{{ route('superadmin.holidays.index') }}"
               class="ems-sidebar__link {{ request()->routeIs('superadmin.holidays.*') ? 'ems-sidebar__link--active' : '' }}">
                <span class="ems-sidebar__icon">
        ...
        <div class="ems-sidebar__section">
            ...
            <a href="{{ route('superadmin.leave-requests.index') }}"
               class="ems-sidebar__link {{ request()->routeIs('superadmin.leave-requests.*') ? 'ems-sidebar__link--active' : '' }}">
                <span class="ems-sidebar__icon">
            ...
            <a href="{{ route('superadmin.leave-types.index') }}"
               class="ems-sidebar__link {{ request()->routeIs('superadmin.leave-types.*') ? 'ems-sidebar__link--active' : '' }}">
                <span class="ems-sidebar__icon">
        ...
        <div class="ems-sidebar__section">
            ...
            <a href="{{ route('superadmin.users.index') }}"
               class="ems-sidebar__link {{ request()->routeIs('superadmin.users.*') ? 'ems-sidebar__link--active' : '' }}">
                <span class="ems-sidebar__icon">
            ...
            <a href="{{ route('superadmin.roles.index') }}"
               class="ems-sidebar__link {{ request()->routeIs('superadmin.roles.*') ? 'ems-sidebar__link--active' : '' }}">
                <span class="ems-sidebar__icon">
